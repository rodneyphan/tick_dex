...
class Tick {
  ...
  List<Tick> tickList = [
    ...
    Tick( "Rocky Mountain Wood tick", "Rickettsia rickettsii", "Rocky Mountain Spotted Fever, Colorado Tick Fever, Tularemia, Q Fever", "rocky_mtn_wood_tick" ),
    Tick( "Cayenne tick", "Amblyomma cajennense", "Rocky Mountain Spotted Fever", "cayenne_tick" ),
    Tick( "Ixodes Ticks - multiple species", "Ixodes xxxxxx", "Lyme's Disease, Babesiosis, Powassan Encephalitis, Anaplasmosis", "ixodes_ticks" ),
    Tick( "African tick", "Amblyomma hebraeum or variegatum", "Tick-borne Relapsing Fever", "african_tick" ),
...
class Disease {
  ...
  List<Disease> diseaseList = [
    ...
    Disease("Babesiosis", "2,420", "https://www.cdc.gov/parasites/babesiosis/index.html"),
    Disease("Ehrlichiosis", "2,093", "https://www.cdc.gov/ehrlichiosis/symptoms/index.html"),
