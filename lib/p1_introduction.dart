  ...
  Widget build (BuildContext context) {
    return Scaffold(
      appBar: AppBar( backgroundColor: Colors.yellowAccent,
        title: const Text(' TICK-DEX - Helping us learn about TICKS and RISKS...', style: TextStyle( color: Colors.brown) ), ),
      body: displayIntro( ),
    );
  } // build (…)
      ...
      child: Column(
        children: <Widget>[
          Padding( padding: const EdgeInsets.all(8.0),
            child: SizedBox ( width: 400.0, height: 350.0,
          ...
          Padding( padding: const EdgeInsets.all(8.0),
            child: SizedBox( width: 190,
              child: ElevatedButton( style: ButtonStyle( backgroundColor: MaterialStateProperty.all<Color>(Colors.yellowAccent) ),
                child: const Text('IDENTIFY MY TICK', style: TextStyle( color: Colors.brown) ),
          ...
          Padding( padding: const EdgeInsets.all(8.0),
            child: SizedBox( width: 190,
              child: ElevatedButton( style: ButtonStyle( backgroundColor: MaterialStateProperty.all<Color>(Colors.lightGreen ) ),
                child: const Text('TICK-BORNE DISEASES', style: TextStyle( color: Colors.brown ), ),
